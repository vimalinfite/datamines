...
//         try {
//             const response = await axios.post(`https://3.109.181.180/cardapi/v1/register?user_id=${localId}`, formData);
...
//   <Typography variant="h6" component="div" sx={{ color: 'black', marginLeft: '10px' }}>
//     Data Mines
//   </Typography>
// </Box>
...
//                             />
//                             <Grid item md={3} xs={5}>
//                                 <Button type="submit" variant="contained" style={{ backgroundColor: '#393bc5', borderRadius: '50px', marginBottom: '10px' }} onClick={sendOtp} fullWidth>
//                                     Send OTP
//                                 </Button>
//                                 {!captchaVerified && (
...
//                             Already a user?<Link to="/" style={{ color: '#393bc5',textDecoration:'none' }}> Please Login</Link>
//                         </Typography>
//                         </div>
//                     </Grid>
