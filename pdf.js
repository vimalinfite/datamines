...
const Dashboard = () => {
  ...
  const fetchUserFiles = async () => {
    try {
      ...
      const response = await fetch(
        `http://134.209.153.179/cardapi/v1/get_user_files?user_id=${uidFromPerformOCR}`,
        requestOptions
      );
  ...
  const fetchUserStatus = async () => {
    try {
      ...
      const response = await fetch(
        `http://134.209.153.179/cardapi/v1/get_all_user?user_id=${uidFromPerformOCR}`,
        requestOptions
      );
      const data = await response.json();
            ...
            {currentItems.map((folder, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <Link
                      to={folder.file_url_excel}
                      download={folder.file_name_excel}
                    >
                    ...
                    <Link
                      to={folder.file_url_pdf}
                      download={folder.file_name_pdf}
                    >
                      <Tooltip title="Download" arrow>
                        <img
                          src={pdfIcon}
                ...
                <span style={{ marginBottom: "4px" }}>
                  {folder.file_name_excel.slice(0, -4)}
                </span>
  ...
  return (
    <>
      <AppBar
        position="relative"
        style={{ backgroundColor: "#393bc5", boxShadow: "none" }}
      >
        <Toolbar
          style={{
        ...
        >
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <Typography
              variant="h6"
              component="div"
              sx={{ flexGrow: 1, color: "white", marginLeft: "10px" }}
            >
              <span
                style={{
                  flexGrow: 1,
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <Typography variant="body1">
            Your account is being activated. This process may take up to 48
            hours. Please wait patiently.
          </Typography>
          <Typography variant="body2">
            If you have any urgent concerns, please contact the administrator.
          </Typography>
        </DialogContent>
        <DialogActions>
